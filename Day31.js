...
//? The password must containat least one lowercase letter, one uppercase letter, and one digit.
...
//* Input:
//? password: A non-empty string representing the password to be valudated.
...
const simplePasswordValidator = (password) => {
  ...
  // console.log(!isNaN("Vivek")); // Output: false
